...
public class GalleryController {
	 ...
	 * 
	 * MultipartHttpServletRequest : form의 input[type='file'] tag애 담겨서 전달되는 여러개의 파일을
	 * 수신하는 객체 여기에는 절대 @requestparam()을 붙여서는 안된다.
	 */
	...
	public String insert(GalleryVO galleryVO, @RequestParam("image_file") MultipartFile image_file,
		...
		try {
			...
			/*
			 * multi file 의 경우는 매개변수의 이름과 form 에서 전달한 이름은 전혀 연관이 없다. multi 파일의 경우는
			 * 변수.getFiles() method를 실행할때 form 에서 설정한 name 속성값을 매개변수로 전달한다.
			 */
