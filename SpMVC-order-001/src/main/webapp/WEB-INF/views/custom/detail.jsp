...
<script src="${rootPath}/static/js/customer.js?2024-03-29"></script>
<body>
	...
	<main class="w3-container">
		<div class="w3-card-4 w3-dark-gray">
			...
			<div class="w3-section w3-center">
				<input data-ccode="${CUST.c_code}" type="button" value="수정"
					class="btn_update w3-button w3-green" /> <input
					data-ccode="${CUST.c_code}" type="button" value="삭제"
