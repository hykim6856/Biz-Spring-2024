 ...
 * 
 * primitive type은 숫자형에 null과 같은 값을 저장할 수 없다.
 * Wrapper class type 은 숫자형 변수에 null 값을 할당할 수 있다.
 * 
 * 숫자형 변수에 저장된 값이 0일때, 
 * 		실제로 0인 값인지, 값이 없는 값인지
 * 		구분하기가 어려울때가 있다.
 * 이때 숫자형 Wrapper 클래스를 사용하여 null 값을 취급하기도 한다.
 * 
 */
@Getter
@Setter
...
/*
 * io_seq 를 wrapper class Long으로 선언하기
 ...
 * 이때 io_seq 없어서 0 인지, 아니면 실제 값이 0인지 판단하기가 매우 어렵다
 */
	private Long io_seq;// INT
